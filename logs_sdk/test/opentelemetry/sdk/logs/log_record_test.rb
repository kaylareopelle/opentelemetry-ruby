  ...
  describe '#initialize' do
    ...
    describe '#attributes=' do
      it 'does not increment dropped_attributes_count when reassigned within the limit' do
        ...
        assert_equal(0, log_record.instance_variable_get(:@dropped_attributes_count))
        assert_equal(0, log_record.to_log_record_data.dropped_attributes_count)
      end
      ...
      it 'does not increment dropped_attributes_count for invalid attributes dropped by validation' do
        log_record = nil
